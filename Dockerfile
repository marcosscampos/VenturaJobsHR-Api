...
WORKDIR /src
COPY ["Services/Jobs/VenturaJobsHR/VenturaJobsHR.Api/VenturaJobsHR.Api.csproj", "VenturaJobsHR.Api/"]
RUN dotnet restore "Services/Jobs/VenturaJobsHR/VenturaJobsHR.Api/VenturaJobsHR.Api.csproj"
COPY . .
